...
public class RuntimeDataGenerator {
	...
	private static void cuttingRecipes(Identifier itemId) {
		...
		if (hasFoundMatch) {
			...
			Identifier stairsId = base.withSuffix(usesPlanksForStairsOrSlabs ? "_planks_stairs" : "_stairs");
			Identifier slabId = base.withSuffix(usesPlanksForStairsOrSlabs ? "_planks_slab" : "_slab");
